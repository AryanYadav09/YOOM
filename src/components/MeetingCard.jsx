...
const MeetingCard = ({ icon, title, date, isPreviousMeeting, buttonIcon1, handleClick, link, buttonText, }) => {
    ...
    return (<section className="flex min-h-[258px] w-full flex-col justify-between rounded-[14px] bg-dark-1 px-5 py-8 xl:max-w-[568px]">
      ...
      <article className={cn("flex justify-center relative", {})}>
        ...
        {!isPreviousMeeting && (<div className="flex gap-2">
